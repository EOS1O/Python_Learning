...
# 实例
[⋌ 反转技术](#反转技术)　　　[⋌ 切片](#切片技术)　　　[⋌ 进制间转换](#进制间转换)　　　[⋌ 整数分离](#整数分离)　　　[⋌ 字符类型判断](#字符类型判断)　　　[⋌ 列表删除技巧](#列表删除)　　　　　[⋌ 列表内操作](#列表内操作)　　　[⋌ For & While](#for--while)　　　[⋌ 列表内字符合一](#列表内字符合一)　　　[⋌ 列表是否为空](#列表是否为空)　　　[⋌ 遍历字符串](#遍历字符串)　　　
## 反转技术
#### List反转
```python
# 法1：使用reverse()方法
...
a = "Hello World"                                                  
for i in a:　　　　　　　　　　　　　　　　　　　　　　　　　　　　　
　print(i)　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　#输出为一行一行的　H e l l o W o r l d 
```
