...
[⋌ 切片](#切片技术)　　　[⋌ range](#range函数)　　　[⋌ set](#set函数)　　　[⋌ pow](#pow方法)
...
## 进制间转换
- 二进制　　　0b101
－以数字0和字母开头，如果出现大于等于2的数，会抛出SyntaxError异常 
- 八进制　　　0711
　－以数字0打头的数字，如果出现大于等于8的数，会抛出SyntaxError异常
- 十六进制　　0x15
　－以数字0和字符x开头，包括0-9和abcdef或ABCDEF，出现其他数值会抛出SyntaxError异常
